...
function write_junit_report() {
...

  {
    ...
    printf '<testsuites name="Dell OMSA Docker image" tests="%d" failures="%d" skipped="%d" time="%s">\n' \
...
function write_markdown_summary() {
  ...
  {
    printf '## Dell OMSA Docker image test suite\n\n'
    ...
    printf ' — %d assertions in %ss, against mocked system commands\n\n' \
