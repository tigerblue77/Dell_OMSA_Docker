...
An instrument for [issue #4](https://github.com/tigerblue77/Dell_OMSA_Docker/issues/4), *"Get rid of
the need to run the container in privileged mode"*, open since March 2023.
...
**One run of this script on a real PowerEdge is worth more than every opinion in issue #4, including
...
storage does not" is the shape of an answer to issue #4 -- it says the BMC path survives a narrower
